        ...
        <div class="modal-dialog">
          <div class="modal-content fadeIn">
            ...
            <div class="modal-body">
              ...
              <span :class='[info_hide, pl2]'><router-link to="/diary/d_edit"><span>發表動態</span></router-link><span
                :class='direct'>|</span><span><router-link to="/message_board/m_edit">給我留言🍀</router-link></span></span>
            </div>
          </div>
        </div>
      </div>
